...
public class LeshanClientDemo {
    ...
    private static TempSensorDevice tempSensorInstance;
    ...
    public static void main(final String[] args) {
        ...
        if (cl.hasOption("sf")) {
            try {
                ...
                System.err.println("Scale factor must be a f9000loat, e.g. 1.0 or 0.01");
                formatter.printHelp(USAGE, options);
                return;
            }
        }
    ...
    public static void createAndStartClient(String endpoint, String localAddress, int localPort, boolean needBootstrap,
        ...
        //
        //tempSensorInstance = new TempSensorDevice();
        //
        ...
        initializer.setClassForObject(OBJECT_ID_TEMPERATURE_SENSOR, TempSensorDevice.class);
        initializer.setInstancesForObject(OBJECT_ID_TEMPERATURE_SENSOR, new TempSensorDevice());
        initializer.setClassForObject(OBJECT_ID_ACTUATOR, ActuatorDevice.class);
        initializer.setInstancesForObject(OBJECT_ID_ACTUATOR, new ActuatorDevice());
