...
public interface RegistrationListener {
    ...
    void updated(RegistrationUpdate update, Registration updatedReg);

    void registered(Registration reg);

    void unregistered(Registration reg, Collection<Observation> arg1);
}
